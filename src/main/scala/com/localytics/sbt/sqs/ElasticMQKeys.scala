...
object ElasticMQKeys {
  ...
  lazy val elasticMQUrl        = settingKey[String]("The URL to download ElasticMQ from. Defaults to 'https://s3-eu-west-1.amazonaws.com/softwaremill-public/elasticmq-server-0.8.12.jar'")
  lazy val elasticMQFileName   = settingKey[String]("The name of the ElasticMQ jar file. Defaults to 'elasticmq-server-{version}.jar'")
  lazy val elasticMQVersion    = settingKey[String]("The version of ElasticMQ. Defaults to '0.8.12'")
